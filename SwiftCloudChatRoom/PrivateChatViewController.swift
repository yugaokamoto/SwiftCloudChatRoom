...
//            visualEffectView.removeFromSuperview()
    ...
    override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!) {
        ...
        let rootRef = Database.database().reference(fromURL: "https://cloudchatroom-53b5e.firebaseio.com/").child("message").child(fromDBAddress).child(roomName)
    ...
    func getInfo(){
        ...
        let firebase = Database.database().reference(fromURL: "https://cloudchatroom-53b5e.firebaseio.com/").child("message").child(fromDBAddress).child(roomName)
